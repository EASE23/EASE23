...
parser.add_argument('--partitioners',metavar="",  nargs='+', type=str, required=False, default=['crvc','hep100','hep10','1ds','1dd','2d','dbh','2ps','hdrf','hep1','ne'], help="The partitioners for which EASE should be applied. Default:all, Options: dbh, 2ps, hdrf, crvc, hep100, hep10, 1ds, 1dd, 2d, hep1, ne")
...
class EASE():
    """ This class represents EASE. EASE consists of four components: 
    ...
    def __init__(
        ...
        Args:
            ...
            processing_model_description list(str, str): For which graph processing should EASE select which model. e.g, [("pr", "XGB"), ("cc", "SVR")]
...
ease.PartitionerSelector(input_df, algorithm=algorithm)