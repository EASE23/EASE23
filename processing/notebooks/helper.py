...
class EASE():
    """ This class represents EASE. It can be used to predict:
        1. Graph Partitioning Run-times
        2. Graph Processing Run-time
        3. Graph Partitioning Quality

        Furthermore, the class can be used to evaluate our two use cases for EASE:
